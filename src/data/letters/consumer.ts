...
[Phone] [Email]`,
  ...
  {
    slug: "unauthorized-auto-repair-charges",
    category: "consumer",
    title: "Unauthorized Auto Repair Charges Dispute Letter (Free Template + State Repair-Estimate Laws)",
    metaDescription: "Shop charged you more than the written estimate — or did work you never approved? Free demand letter citing state Auto Repair Acts (CA, NY, FL, WA) + UDAP.",
    lede: "You dropped the car off for one repair. You picked it up with a bill for a lot more — work you never said yes to. Most states require a shop to give you a written estimate and get your authorization, written or oral, before exceeding it. This letter cites your state's Automotive Repair Act (or Motor Vehicle Repair Act) and demands a refund of everything charged beyond what you actually authorized.",
    body: "[Your Full Name]\n[Your Address]\n[City, State ZIP]\n[Phone] [Email]\n\n[MM/DD/YYYY]\n\n[Repair Shop Legal Name]\n[Shop Address]\n[City, State ZIP]\n\nSent via certified mail, return receipt requested\n(Copy also emailed to [shop email] for the record.)\n\nRe: Demand for Refund of Unauthorized Repair Charges — Repair Order #[Number], [Vehicle Year/Make/Model], VIN [Last 6 digits]\n\nDear [Shop Manager / Owner Name]:\n\nI am writing to formally dispute charges billed to me on [Date of Invoice] that exceeded the written estimate I received and/or that I never authorized, in violation of [State]'s automotive repair statute.\n\nFacts:\n  • Date vehicle dropped off: [Date]\n  • Written estimate provided: [Yes/No — if yes, attach copy] for $[Estimate Amount], on [Date Estimate Given]\n  • Work I actually authorized: [Describe exactly what you approved — quote any text message, phone call, or signed authorization]\n  • Final invoice amount: $[Invoice Total]\n  • Amount charged beyond what I authorized: $[Disputed Amount]\n  • How I learned of the additional work: [Describe — e.g., \"only when I arrived to pick up the vehicle and was presented with the final invoice\"]\n  • Any contact from the shop before performing the additional work: [None / Describe call or text and when it occurred relative to the work being done]\n\nLegal basis:\n\n  Under [State]'s automotive/motor vehicle repair statute, a repair shop may not charge for labor or parts beyond a written estimate without first obtaining my written or oral authorization, documented with the date, time, and dollar amount approved:\n  • California: Bus. & Prof. Code § 9884.9 — no charge for work or parts in excess of the estimate without customer consent, which must be documented (in writing, or orally with date/time/name/phone/cost noted on the invoice or a customer signature confirming approval).\n  • New York: Vehicle & Traffic Law § 398-d — a shop \"shall not charge for work done or parts supplied in excess of the estimate without the consent of such customer.\"\n  • Florida: Fla. Stat. § 559.905 — shops must present a written estimate or a cost ceiling the shop \"may not exceed... without my written or oral approval,\" and must disclose this in writing before beginning work costing over $150.\n  • Washington: RCW 46.71.025 — a repair facility may not charge more than 110% of the written estimate without the customer's oral or written authorization to exceed it.\n\n  [If your state has no repair-specific statute, delete the above and cite your state's general Unfair or Deceptive Acts and Practices (UDAP) / Consumer Protection Act instead — charging for unauthorized work is a textbook unfair or deceptive practice in every state.]\n\n  Regardless of the specific statute, billing a customer for work never authorized also constitutes breach of contract (no meeting of the minds on the additional scope) and, in most states, an independently actionable unfair or deceptive trade practice.\n\nDemand:\n\n  Within [14] days of receipt of this letter, please refund $[Disputed Amount] — the portion of the bill I did not authorize — by [check mailed to the address above / credit to the card on file].\n\n  I am not disputing the portion of the bill I did authorize: $[Authorized Amount]. This is a targeted dispute of the unauthorized overage only.\n\nIf I do not receive a refund or a written response within [14] days, I will:\n  • File a complaint with [state regulator — CA Bureau of Automotive Repair (BAR); NY DMV Motor Vehicle Repair Shop Registration Program; FL Department of Agriculture and Consumer Services (FDACS); WA Attorney General's Office] and request restitution and an investigation of this shop's registration.\n  • Dispute the charge with my credit card issuer as an unauthorized/incorrect-amount transaction under the Fair Credit Billing Act, if paid by credit card.\n  • File a complaint with my state Attorney General's consumer protection division and, where applicable, small claims court for the disputed amount plus statutory damages and fees available under [State]'s consumer protection act.\n\nPlease send your written response to the address above.\n\nSincerely,\n\n[Your Signature]\n[Your Printed Name]\n\nEnclosures: [written estimate (if any); final invoice; any text/email/call records showing what was or wasn't authorized; photos of the vehicle/repair order]",
    howToUse: ["Pull every piece of paper the shop gave you before disputing anything: the written estimate (if any), the signed repair order, and the final invoice. Compare the authorized scope line-by-line against the final invoice — the gap between them is your disputed amount.", "Reconstruct the authorization trail. Most state statutes let a shop get oral authorization for extra work, but only if it's documented (date, time, name of authorizing person, phone number, and dollar amount — often on the invoice itself or via a follow-up text/email). If the shop can't produce that documentation, the statute treats the extra charge as unauthorized regardless of what they claim happened over the phone.", "Don't dispute the whole bill — only the overage. Letters that concede the authorized portion and isolate the specific unauthorized amount are both more credible and easier for the shop (or a regulator) to act on quickly.", "If you paid by credit card, you have a second, faster track: dispute the specific charge amount with your card issuer under the Fair Credit Billing Act (15 U.S.C. § 1666) while the demand letter runs in parallel — a chargeback doesn't require the shop's cooperation.", "Identify your state's regulator before you send the letter, not after. States that license or register repair shops (California's Bureau of Automotive Repair, New York's DMV Motor Vehicle Repair Shop Registration Program) can suspend or revoke a shop's registration and order restitution — naming the regulator in the letter itself is often what gets a fast response."],
    legalContext: ["A large group of states require automotive repair shops to give customers a written estimate before starting work and to get the customer's authorization — written or documented oral consent — before charging for anything beyond that estimate. California's Automotive Repair Act, Bus. & Prof. Code § 9884.9, is the model: a registered automotive repair dealer must give a written estimate for a specific job and may not charge for work or parts in excess of that estimate without the customer's consent, which must itself be documented (in writing via email/fax, or orally with the date, time, authorizing person's name, phone number, and cost noted on the invoice or confirmed by the customer's signature). A shop that skips this step and simply bills for the extra work has violated the statute regardless of whether the work was competently performed.", "Other states use different mechanics to reach the same result. New York's Vehicle and Traffic Law Article 12-A (Motor Vehicle Repair Shop Registration Act), § 398-d, states plainly that a shop \"shall not charge for work done or parts supplied in excess of the estimate without the consent of such customer\" — and § 398-e backs that with civil penalties of up to $750 for a first violation and up to $1,000 for repeat violations within 30 months, enforced by the DMV against the shop's registration. Florida's Motor Vehicle Repair Act, Fla. Stat. § 559.905, requires a written estimate (or a customer-selected cost ceiling) before work begins on any repair likely to exceed $150, and the disclosure the customer signs states in capital letters that \"THE SHOP MAY NOT EXCEED THIS AMOUNT WITHOUT MY WRITTEN OR ORAL APPROVAL.\" Washington's RCW 46.71.025 caps unauthorized overage at 110% of the written estimate and, notably, RCW 46.71.070 makes any violation of the chapter a per se unfair or deceptive act under Washington's Consumer Protection Act (RCW 19.86) — meaning a customer can bring the CPA's private right of action, with treble damages up to $25,000 and mandatory attorney's fees, directly off a violation of the repair-estimate rule.", "States without a dedicated Auto Repair Act still reach unauthorized-charge disputes through their general Unfair or Deceptive Acts and Practices (UDAP) / Consumer Protection statute — billing a customer for services never agreed to is a textbook unfair or deceptive practice in virtually every state's general consumer-protection framework, and most of those statutes (like Washington's, above) provide multiple damages and attorney's-fee-shifting that a plain breach-of-contract claim would not. A demand letter should lead with the state-specific repair statute where one exists, and fall back to the general UDAP statute where it doesn't.", "Paying by credit card opens a second, independent remedy that doesn't depend on the shop's cooperation at all: the Fair Credit Billing Act (15 U.S.C. § 1666) lets a cardholder dispute a billing error — including a charge for goods or services not accepted or not delivered as agreed — directly with the card issuer, in writing, within 60 days of the first statement showing the error. An unauthorized repair-overage charge fits squarely within that definition."],
    stateNotes: [{"state": "California", "note": "Bus. & Prof. Code § 9884.9 (written estimate + documented consent before exceeding it) + § 9884.7 (grounds for suspension/revocation of the repair dealer's registration, including untrue statements and failure to follow required documentation). Regulator: Bureau of Automotive Repair (BAR) — accepts consumer complaints and can order restitution as part of discipline."}, {"state": "New York", "note": "Vehicle & Traffic Law Article 12-A, § 398-d (no charge beyond the estimate without customer consent) + § 398-e (civil penalties up to $750 first violation, $1,000 repeat violations within 30 months; DMV can suspend/revoke registration and order restitution to the complainant). Regulator: NY DMV Motor Vehicle Repair Shop Registration Program."}, {"state": "Florida", "note": "Fla. Stat. § 559.905 (Motor Vehicle Repair Act) — written estimate or cost-ceiling disclosure required before work over $150; shop may not exceed the ceiling without written or oral approval. Regulator: Florida Department of Agriculture and Consumer Services (FDACS), which also administers the general Florida Deceptive and Unfair Trade Practices Act (Fla. Stat. § 501.204) as a fallback claim."}, {"state": "Washington", "note": "RCW 46.71.025 (written estimate; may not charge more than 110% of the estimate without authorization) + RCW 46.71.070 (any violation is a per se unfair/deceptive act under the state Consumer Protection Act, RCW 19.86 — treble damages up to $25,000 + mandatory attorney's fees available in a CPA action; the statute expressly rules out criminal liability for a bare violation)."}, {"state": "Other states", "note": "If your state doesn't have a dedicated Auto Repair Act, cite your state's general UDAP / Consumer Protection Act instead — charging for work never authorized is an unfair or deceptive practice under essentially every state's general consumer-protection statute, and many (like Washington's above) provide multiple damages and fee-shifting. Check your state Attorney General's consumer protection page for the citation and any pre-suit notice requirement before filing suit."}],
    ifThisDoesntWork: "If the shop ignores the letter or refuses to refund the unauthorized amount, you have several parallel tracks. First, file a complaint with your state's repair-shop regulator where one exists — California's BAR, New York's DMV Motor Vehicle Repair Shop Registration Program, or your state Attorney General's consumer protection division otherwise; these agencies can investigate, order restitution, and suspend or revoke the shop's registration, which gives them leverage a private letter doesn't have. Second, if you paid by credit card, dispute the specific overage amount with your card issuer under the Fair Credit Billing Act (15 U.S.C. § 1666) — this doesn't require the shop's cooperation and often resolves faster than a direct demand. Third, small claims court is well-suited to these disputes: the dollar amounts are typically well under small-claims limits, the documentation (estimate vs. invoice) is straightforward, and states with a private UDAP right of action (like Washington's CPA) can multiply the recovery and add attorney's fees even in a self-represented small-claims filing. Keep the written estimate, the final invoice, and any text/call log showing what was or wasn't authorized — that comparison is the entire case.",
    relatedSlugs: ["refund-demand-merchant", "contractor-non-performance", "warranty-claim-magnuson-moss", "billing-error-dispute", "chargeback-escalation", "lemon-law-demand"],
    faqs: [{"question": "The shop called me and I said 'yeah, go ahead' over the phone — does that count as authorization?", "answer": "It can, but only if the shop documented it the way the statute requires. California's § 9884.9 requires the shop to note the date, time, the name of the person who authorized it, their phone number, and the cost on the invoice — or get your signature confirming you received notice and approved it. New York and Florida have similar documentation requirements. A shop that just says 'you told us to' without that paper trail hasn't met the statutory bar, and the charge is treated as unauthorized."}, {"question": "What if I never got a written estimate at all?", "answer": "That's a separate, often stronger violation. Most repair statutes require the shop to offer a written estimate before starting work (California, New York, Florida, Washington all require this). If no estimate was ever provided or offered, the shop is on weaker ground defending any amount above what you can show you actually agreed to verbally at drop-off — and the failure to offer an estimate is itself a statutory violation you can cite to the regulator."}, {"question": "Can I get the whole bill refunded, or just the amount I didn't authorize?", "answer": "Generally just the unauthorized overage — the work you did agree to is a valid charge. The letter is deliberately scoped to the disputed amount because it's both more legally accurate (you have a real contract for the authorized portion) and more likely to get a fast response than a demand for the entire bill."}, {"question": "The shop is threatening to keep my car (a mechanic's lien) until I pay the full bill. Can they do that?", "answer": "Most states give repair shops a mechanic's or garageman's lien for amounts actually owed, but that lien generally only attaches to properly authorized charges — it doesn't give the shop the right to hold your car hostage over disputed, unauthorized amounts. If this happens, note it in your regulator complaint and consider consulting a local attorney quickly, since lien-release procedures and deadlines are state- and often county-specific."}],
