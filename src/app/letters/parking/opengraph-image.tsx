...
export const alt = "Fight a parking ticket, city by city — I'm Frustrated dot Org";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          Fight a parking ticket — city by city.
        </div>
        ...
        <div style={{ display: "flex", marginTop: 28 }}>
          ...
          >
            Free · city-specific · verified against official rules
          </span>
        </div>
