...
import { getParkingCity } from "@/data/parking";

export const runtime = "edge";
export const alt = "Fight a parking ticket — I'm Frustrated dot Org";
...
export default async function Image({
  ...
  const title = c ? `Fight a parking ticket in ${c.city}` : "Fight a Parking Ticket";
